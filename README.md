...
```bash
# Using npm
npm install @my-little-team/stackone-ai zod

# Using yarn
yarn add @my-little-team/stackone-ai zod

# Using pnpm
pnpm add @my-little-team/stackone-ai zod

# Using bun
bun add @my-little-team/stackone-ai zod
```
...
```bash
npm install @my-little-team/stackone-ai openai  # or: yarn/pnpm/bun add
```
...
```bash
npm install @my-little-team/stackone-ai @anthropic-ai/sdk  # or: yarn/pnpm/bun add
```
...
```bash
npm install @my-little-team/stackone-ai ai @ai-sdk/openai  # or: yarn/pnpm/bun add
```
...
```bash
npm install @my-little-team/stackone-ai @anthropic-ai/claude-agent-sdk zod  # or: yarn/pnpm/bun add
```
...
When passing an explicit object, missing fields fall back to `DEFAULT_DEFENDER_CONFIG` (exported from `@my-little-team/stackone-ai`): `enabled: true`, `blockHighRisk: false`, both tiers on.

#### Configuration modes

```typescript
import { StackOneToolSet, DEFAULT_DEFENDER_CONFIG } from '@my-little-team/stackone-ai';
...
import { isBinaryDownloadResult, StackOneToolSet } from '@my-little-team/stackone-ai';
